...
class WPUF_Admin_Settings {
    ...
    function admin_menu() {
        ...
        add_submenu_page( 'wpuf-admin-opt', __( 'Registration Forms', 'bediq' ), __( 'Registration Forms', 'bediq' ), $capability, 'edit.php?post_type=wpuf_profile' );
        add_submenu_page( 'wpuf-admin-opt', __( 'Subscription', 'bediq' ), __( 'Subscription', 'bediq' ), $capability, 'edit.php?post_type=wpuf_subscription' );
        add_submenu_page( 'wpuf-admin-opt', __( 'Coupons', 'bediq' ), __( 'Coupons', 'bediq' ), $capability, 'edit.php?post_type=wpuf_coupon' );
