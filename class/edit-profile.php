        ...
        <div class="wpuf-profile">
            <form name="profile" id="your-profile" action="" method="post">
                ...
                <fieldset>
                    ...
                    <table class="wpuf-table">
                        ...
                        foreach (_wp_get_user_contactmethods() as $name => $desc) {
                            ?>
                            <tr>
                                <th><label for="wpuf-<?php echo $name; ?>"><?php echo apply_filters( 'user_' . $name . '_label', $desc ); ?></label></th>
                                <td><input type="text" name="<?php echo $name; ?>" id="wpuf-<?php echo $name; ?>" value="<?php echo esc_attr( $profileuser->$name ) ?>" class="regular-text" /></td>
                            </tr>
                            <?php
                        }
                        ?>
                ...
                <fieldset>
                    ...
                    <table class="wpuf-table">
                        <tr>
                            <th><label for="wpuf-description"><?php _e( 'Biographical Info', 'wpuf' ); ?></label></th>
                            <td><textarea name="description" id="wpuf-description" rows="5" cols="30"><?php echo esc_html( $profileuser->description ); ?></textarea><br />
