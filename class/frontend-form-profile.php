        ...
        if (is_wp_error($user_id)) {
            ...
            if ($user_id) {
                ...
                $response = array(
                    ...
                    'message'      => (isset($form_settings['enable_email_verification']) && $form_settings['enable_email_verification'] == 'yes') ? __('Please check your email for activation link',
                        'wpuf') : $form_settings['message']
                );
